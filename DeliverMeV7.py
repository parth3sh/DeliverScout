...
def run_requests_session(selenium_cookies, url, headers):
    with requests.Session() as session:
        ...
        return raw_data_dictionary
#===================================================================================================================================================
    #AUTO BROWSER & GET REQUESTS FOR RAW AVAILABILITY DATA // RETURNS RAW JSON AVAILABILITY DATA // FUNCTION
def get_raw_availability_data(current_zip_code, current_city):
...
def main_Script_Function(Account_Database):
    for x in range(len(Account_Database)):
        ...
        raw_data_dictionary = get_raw_availability_data(current_zip_code, current_city)
